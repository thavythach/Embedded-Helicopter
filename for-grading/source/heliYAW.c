/*
 * HeliYAW.c contains the interrupt handler used for quadrature decoding of the yaw input signals,
 * an interrupt handler to process the initial yaw position, and code for orienting the copter
 * to its initial yaw position.
 */
